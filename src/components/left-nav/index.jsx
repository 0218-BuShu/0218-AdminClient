...
class LeftNav extends Component {
  // 根据menu中数据中数组生成包含<Item> / <SubMenu>数组
    ...
    return menuList.reduce((pre, item) => {
      ...
      if (!item.children) {
        ...
        pre.push(
          ...
          >
            {this.getMenusNodes2(item.children)}
          </SubMenu>
        );
      }
      return pre;
  ...
  render() {
    ...
    const menuNodes = this.getMenusNodes2(menuList)
    //将请求的路由路径作为选中的key
    ...
    return (
      <div className="left-nav">
        ...
        <Menu mode="inline" theme="dark" selectedKeys={[selectedKey]} defaultOpenKeys={[openKey]}>
          {menuNodes}
          {/* <Item key="/home">
            <Link to="/home">
              <Icon type="home" />
